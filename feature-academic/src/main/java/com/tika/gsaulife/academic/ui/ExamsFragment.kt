...
internal class ExamsFragment : Fragment(), AcademicPage {
    override val destination = AcademicDestination.EXAMS
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.academicToolbar.setTitle(R.string.academic_feature_exams)
    ...
    private fun render(page: ExamPage, fetchedAt: Long? = null, needsLogin: Boolean = false) {
        binding.academicToolbar.subtitle = page.term
        ...
        if (page.exams.isEmpty()) {
            ...
            binding.academicState.showEmpty(
                R.drawable.academic_ic_exams,
                getString(R.string.academic_exams_empty),
            )
            return
        }
    ...
    private fun showLoading() {
        binding.academicToolbar.subtitle = null
        binding.academicList.visibility = View.GONE
